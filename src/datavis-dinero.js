...
function PlotDineros(dineros, scene) {
      ...
      this.montones =  dineros.map(function (d) {
          ...
          if (prevMonton != null) {
              monton.gameObject.x = prevMonton.gameObject.x + prevMonton.gameObject.width*0.75 + 50;
              monton.gameObject.y = prevMonton.gameObject.y + prevMonton.gameObject.height*1.1 - monton.gameObject.height;
          }
          prevMonton = monton;
          that.container.add(monton.gameObject);
          monton.render();
          return monton;
      });
